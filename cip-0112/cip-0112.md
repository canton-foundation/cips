...
Transaction \#1 is eliminated by 4.3.5.2.
Transaction \#2 collapses to a single view to directly call `AllocationFactory_Allocate` due to the X Allocation view and root node being eliminated by 4.3.5.4.
Transactions \#3-\#5 are eliminated by 4.3.5.4.
...
* Based on 4.3.5.3, both the X and \$ apps create single views for `SettlementFactory_SettleBatch`.
